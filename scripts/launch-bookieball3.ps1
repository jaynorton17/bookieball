...
Write-Host ""
Write-Host "  âš½ BookieBall v$appVersion  âš½" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "  ðŸŒ App  : $webUrl" -ForegroundColor Cyan
Write-Host "  ðŸ“ Repo : $repoRoot" -ForegroundColor DarkGray
Write-Host ""
