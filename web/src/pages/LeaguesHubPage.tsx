...
const leagueTiles: LeagueTile[] = [
  {
    ...
    badge: 'Official',
    title: 'Divisions',
    description: 'Division tables, form, and playoffs.',
    tone: 'league',
  },
  {
    to: '/master-league',
    ...
    badge: '24 clubs',
    title: 'Master League',
    description: 'Single-table race across all teams.',
    tone: 'format',
  },
  {
    to: '/trio-league',
    ...
    badge: '3 tiers',
    title: 'Trio Leagues',
    description: 'Three-tier structure with promotion playoffs.',
    tone: 'format',
  },
  {
    to: '/tier-league',
    ...
    badge: '8 tiers',
    title: 'Tier League',
    description: 'Eight three-team divisions with cross-tier clashes.',
    tone: 'format',
  },
  {
    to: '/all-time-league',
    ...
    description: 'Points, spins, and profit archives.',
    tone: 'archive',
  },
];
